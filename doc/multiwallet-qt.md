...
In order to support loading of multiple wallets in bring-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is bring.cpp.
...
Changes to bring.cpp
----------------------
bring.cpp is the entry point into bring-qt, and as such, will require some minor modifications to provide hooks for
