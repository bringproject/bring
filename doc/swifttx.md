...
This mechanism has been integrated into Bitcore-Node-Bring which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/Bring-Project/insight-api-bring#web-socket-api](https://github.com/Bring-Project/insight-api-bring#web-socket-api) 
* API: [https://github.com/Bring-Project/insight-api-bring#swifttx-transactions](https://github.com/Bring-Project/insight-api-bring#swifttx-transactions) 
...
By default, the Bring Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Bring Core daemon:
