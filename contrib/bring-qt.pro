...
RESOURCES += src/qt/bring.qrc src/qt/bring_locale.qrc

TRANSLATIONS += src/qt/locale/bring_bg.ts \
                src/qt/locale/bring_de.ts \
                src/qt/locale/bring_en.ts \
                src/qt/locale/bring_es.ts \
                src/qt/locale/bring_fi.ts \
                src/qt/locale/bring_fr.ts \
                src/qt/locale/bring_it.ts \
                src/qt/locale/bring_ja.ts \
                src/qt/locale/bring_pl.ts \
                src/qt/locale/bring_pt.ts \
                src/qt/locale/bring_ru.ts \
                src/qt/locale/bring_sk.ts \
                src/qt/locale/bring_sv.ts \
                src/qt/locale/bring_vi.ts \
                src/qt/locale/bring_zh_CN.ts \
                src/qt/locale/bring_zh_TW.ts
