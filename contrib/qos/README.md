...
This means one can have an always-on bringd instance running, and another local bringd/bring-qt instance which connects to this node and receives blocks from it.
