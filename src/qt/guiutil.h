...
/** Utility functions used by the Bring Qt UI.
 */
namespace GUIUtil
{
...
// Render Bring addresses in monospace font
...
// Parse "bring:" URI into recipient object, return true on successful parsing
