...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        {"bring", "masternodeconnect", &masternodeconnect, true, true, false},
        {"bring", "masternodecurrent", &masternodecurrent, true, true, false},
        {"bring", "masternodedebug", &masternodedebug, true, true, false},
        {"bring", "startmasternode", &startmasternode, true, true, false},
        {"bring", "createmasternodekey", &createmasternodekey, true, true, false},
        {"bring", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"bring", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"bring", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"bring", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"bring", "getmasternodescores", &getmasternodescores, true, true, false},
        {"bring", "mnbudget", &mnbudget, true, true, false},
        {"bring", "preparebudget", &preparebudget, true, true, false},
        {"bring", "submitbudget", &submitbudget, true, true, false},
        {"bring", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"bring", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"bring", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"bring", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"bring", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"bring", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"bring", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"bring", "checkbudgets", &checkbudgets, true, true, false},
        {"bring", "mnsync", &mnsync, true, true, false},
        {"bring", "spork", &spork, true, true, false},
        {"bring", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"bring", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use bringd, or the -server option to bring-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> bring-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:4205/\n";
}
