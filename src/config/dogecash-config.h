/* src/config/bring-config.h.  Generated from bring-config.h.in by configure.  */
/* src/config/bring-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef Bring_CONFIG_H

#define Bring_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.bring.io"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Bring"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Bring 2.2.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "bring"
