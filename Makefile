...
pkgdatadir = $(datadir)/bring
pkgincludedir = $(includedir)/bring
pkglibdir = $(libdir)/bring
pkglibexecdir = $(libexecdir)/bring
...
CONFIG_HEADER = $(top_builddir)/src/config/bring-config.h
...
am__DIST_COMMON = $(srcdir)/Makefile.in \
	...
	$(top_srcdir)/src/config/bring-config.h.in \
...
ACLOCAL = ${SHELL} /Users/akshaycm/Documents/compilebring3/build-aux/missing aclocal-1.16
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
AUTOCONF = ${SHELL} /Users/akshaycm/Documents/compilebring3/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /Users/akshaycm/Documents/compilebring3/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /Users/akshaycm/Documents/compilebring3/build-aux/missing automake-1.16
AWK = awk
BDB_CPPFLAGS = 
BDB_LIBS = -ldb_cxx-4.8
BITCOIN_CLI_NAME = bring-cli
BITCOIN_DAEMON_NAME = bringd
BITCOIN_GUI_NAME = bring-qt
BITCOIN_TX_NAME = bring-tx
...
CPPFLAGS = -I/usr/local/opt/openssl/include -DBOOST_SPIRIT_THREADSAFE -DHAVE_BUILD_INFO -D__STDC_FORMAT_MACROS -I/usr/local/opt/berkeley-db@4/include -DMAC_OSX  -U_FORTIFY_SOURCE -D_FORTIFY_SOURCE=2
...
LUPDATE = 
MAINT = 
MAKEINFO = ${SHELL} /Users/akshaycm/Documents/compilebring3/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
MINIUPNPC_LIBS = 
...
OTOOL64 = :
PACKAGE = bring
PACKAGE_BUGREPORT = www.bring.io
PACKAGE_NAME = Bring
PACKAGE_STRING = Bring 2.2.0
PACKAGE_TARNAME = bring
PACKAGE_URL = 
PACKAGE_VERSION = 2.2.0
PATH_SEPARATOR = :
PKG_CONFIG = /usr/local/bin/pkg-config
PKG_CONFIG_LIBDIR = 
PKG_CONFIG_PATH = /usr/local/Cellar/qt/5.11.1/lib/pkgconfig:/usr/local/opt/openssl/lib/pkgconfig:/usr/local/opt/openssl/lib/pkgconfig
PORT = 
PROTOBUF_CFLAGS = 
PROTOBUF_LIBS = 
PROTOC = 
...
ZMQ_CFLAGS = 
ZMQ_LIBS = 
abs_builddir = /Users/akshaycm/Documents/compilebring3
abs_srcdir = /Users/akshaycm/Documents/compilebring3
abs_top_builddir = /Users/akshaycm/Documents/compilebring3
abs_top_srcdir = /Users/akshaycm/Documents/compilebring3
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /Users/akshaycm/Documents/compilebring3/build-aux/install-sh
...
COVERAGE_INFO = baseline_filtered_combined.info baseline.info block_test.info \
  leveldb_baseline.info test_bring_filtered.info total_coverage.info \
  baseline_filtered.info block_test_filtered.info \
  leveldb_baseline_filtered.info test_bring_coverage.info test_bring.info

OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  $(OSX_APP)/Contents/Resources/bitcoin.icns $(OSX_APP)/Contents/Info.plist \
  $(OSX_APP)/Contents/MacOS/Bring-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
src/config/bring-config.h: src/config/stamp-h1
	@test -f $@ || rm -f src/config/stamp-h1
	@test -f $@ || $(MAKE) $(AM_MAKEFLAGS) src/config/stamp-h1

src/config/stamp-h1: $(top_srcdir)/src/config/bring-config.h.in $(top_builddir)/config.status
	@rm -f src/config/stamp-h1
	cd $(top_builddir) && $(SHELL) ./config.status src/config/bring-config.h
$(top_srcdir)/src/config/bring-config.h.in:  $(am__configure_deps) 
	($(am__cd) $(top_srcdir) && $(AUTOHEADER))
	rm -f src/config/stamp-h1
	touch $@

distclean-hdr:
	-rm -f src/config/bring-config.h src/config/stamp-h1
...
$(OSX_APP)/Contents/MacOS/Bring-Qt: $(BITCOIN_QT_BIN)
	$(MKDIR_P) $(@D)
...
#$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/Bring-Qt
...
#$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/Bring-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
...
#test_bring.info: baseline_filtered_combined.info
#	$(MAKE) -C src/ check
#	$(LCOV) -c -d $(abs_builddir)/src -t test_bring -o $@
#	$(LCOV) -z -d $(abs_builddir)/src
#	$(LCOV) -z -d $(abs_builddir)/src/leveldb

#test_bring_filtered.info: test_bring.info
#	$(LCOV) -r $< "/usr/include/*" -o $@

#block_test.info: test_bring_filtered.info
#	$(MKDIR_P) qa/tmp
...
#test_bring_coverage.info: baseline_filtered_combined.info test_bring_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_bring_filtered.info -o $@

#total_coverage.info:  baseline_filtered_combined.info test_bring_filtered.info block_test_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_bring_filtered.info -a block_test_filtered.info -o $@ | $(GREP) "\%" | $(AWK) '{ print substr($$3,2,50) "/" $$5 }' > coverage_percent.txt

#test_bring.coverage/.dirstamp:  test_bring_coverage.info
#	$(GENHTML) -s $< -o $(@D)
#	@touch $@
...
#cov: test_bring.coverage/.dirstamp total.coverage/.dirstamp

.INTERMEDIATE: $(COVERAGE_INFO)

clean-local:
	rm -rf test_bring.coverage/ total.coverage/ $(OSX_APP)
