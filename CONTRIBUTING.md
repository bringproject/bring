Contributing to Bring
============================

The Bring project operates an open contributor model where anyone is
...
The following applies to code changes to the Bring project, and is not to be
confused with overall BringNetwork Protocol consensus changes.

Whether a pull request is merged into Bring rests with the project merge
...
Patches that change Bringconsensus rules are considerably more involved than
...
Where a patch set proposes to change the Bringconsensus, it must have been
...
The project leader is the release manager for each Bring release.
