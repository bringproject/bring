...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='bring.conf'
CONFIGFOLDER='/root/.bring'
COIN_DAEMON='bringd'
COIN_CLI='bring-cli'
COIN_PATH='/usr/local/bin/'
COIN_REPO=''
COIN_TGZ='https://github.com/bring/bring/releases/download/2.3/bring.zip'
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_NAME='Bring'
COIN_PORT=4204 #Updated Port
RPC_PORT=4205
...
function prepare_system() {
 cd ~
echo "BringMN installer Depends Starting"
